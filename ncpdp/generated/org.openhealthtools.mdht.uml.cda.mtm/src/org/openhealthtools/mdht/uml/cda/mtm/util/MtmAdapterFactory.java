...
public class MtmAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MtmSwitch<Adapter> modelSwitch =
    new MtmSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePersonalMedicationList(PersonalMedicationList object)
      {
        return createPersonalMedicationListAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseMedicationActionPlan(MedicationActionPlan object)
      {
        return createMedicationActionPlanAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.mtm.PersonalMedicationList <em>Personal Medication List</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPersonalMedicationListAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.mtm.MedicationActionPlan <em>Medication Action Plan</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createMedicationActionPlanAdapter()
  {
    return null;
  }
