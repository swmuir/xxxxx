...
public class TelecomPackageImpl extends EPackageImpl implements TelecomPackage {
	...
	public static TelecomPackage init() {
		...
		ExternalCodeListPackage.eINSTANCE.eClass();
	...
	public void initializePackageContents() {
		...
		ExternalCodeListPackage theExternalCodeListPackage = (ExternalCodeListPackage)EPackage.Registry.INSTANCE.getEPackage(ExternalCodeListPackage.eNS_URI);
		...
		initEAttribute(getTransactionHeaderSegment_TransactionCount(), theExternalCodeListPackage.getTransactionCount(), "transactionCount", null, 1, 1, TransactionHeaderSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getTransactionHeaderSegment_TransactionCode(), theExternalCodeListPackage.getTransactionCode(), "transactionCode", null, 1, 1, TransactionHeaderSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getWorkersCompensationSegment_BillingEntityTypeIndicator(), theExternalCodeListPackage.getBillingEntityTypeIndicator(), "billingEntityTypeIndicator", null, 0, -1, WorkersCompensationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getWorkersCompensationSegment_PayToQualifier(), theExternalCodeListPackage.getPayToQualifier(), "payToQualifier", null, 0, -1, WorkersCompensationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPriorAuthorizationSegment_RequestType(), theExternalCodeListPackage.getRequestType(), "requestType", null, 0, -1, PriorAuthorizationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPricingSegment_BasisOfCostDetermination(), theExternalCodeListPackage.getBasisOfCostDetermination(), "basisOfCostDetermination", null, 0, -1, PricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPatientSegment_PatientIdQualifier(), theExternalCodeListPackage.getPatientIDQualifier(), "patientIdQualifier", null, 0, -1, PatientSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPatientSegment_PatientGenderCode(), theExternalCodeListPackage.getPatientGenderCode(), "patientGenderCode", null, 0, -1, PatientSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPatientSegment_PlaceOfService(), theExternalCodeListPackage.getPatientLocation(), "placeOfService", null, 0, -1, PatientSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPatientSegment_PregnancyIndicator(), theExternalCodeListPackage.getPregnancyIndicator(), "pregnancyIndicator", null, 0, -1, PatientSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPatientSegment_PatientResidence(), theExternalCodeListPackage.getPatientResidence(), "patientResidence", null, 0, -1, PatientSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInsuranceSegment_EligibilityClarificationCode(), theExternalCodeListPackage.getEligibilityClarificationCode(), "eligibilityClarificationCode", null, 0, -1, InsuranceSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInsuranceSegment_PatientRelationshipCode(), theExternalCodeListPackage.getPatientRelationshipCode(), "patientRelationshipCode", null, 0, -1, InsuranceSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInsuranceSegment_ProviderAcceptAssignmentIndicator(), theExternalCodeListPackage.getProviderAcceptAssignmentIndicator(), "providerAcceptAssignmentIndicator", null, 0, -1, InsuranceSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getInsuranceSegment_CmsPartDDefinedQualifiedFacility(), theExternalCodeListPackage.getCMSPartDDefinedQualifiedFacility(), "cmsPartDDefinedQualifiedFacility", null, 0, -1, InsuranceSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getDURPPSSegment_ReasonForServiceCode(), theExternalCodeListPackage.getReasonforServiceCode(), "reasonForServiceCode", null, 0, -1, DURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getDURPPSSegment_ProfessionalServiceCode(), theExternalCodeListPackage.getProfessionalServiceCode(), "professionalServiceCode", null, 0, -1, DURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getDURPPSSegment_ResultOfServiceCode(), theExternalCodeListPackage.getResultofServiceCode(), "resultOfServiceCode", null, 0, -1, DURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getDURPPSSegment_DurCoagentIdQualifier(), theExternalCodeListPackage.getDURCoAgentIDQualifier(), "durCoagentIdQualifier", null, 0, -1, DURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCouponSegment_CouponType(), theExternalCodeListPackage.getCouponType(), "couponType", null, 0, -1, CouponSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCoordinationofBenefitsOtherPaymentsSegment_OtherPayerCoverageType(), theExternalCodeListPackage.getOtherPayerCoverageType(), "otherPayerCoverageType", null, 0, -1, CoordinationofBenefitsOtherPaymentsSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCoordinationofBenefitsOtherPaymentsSegment_OtherPayerIdQualifier(), theExternalCodeListPackage.getOtherPayerIDQualifier(), "otherPayerIdQualifier", null, 0, -1, CoordinationofBenefitsOtherPaymentsSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCoordinationofBenefitsOtherPaymentsSegment_OtherPayerpatientResponsibilityAmountQualifier(), theExternalCodeListPackage.getOtherPayerPatientResponsibilityAmountQualifier(), "otherPayerpatientResponsibilityAmountQualifier", null, 0, -1, CoordinationofBenefitsOtherPaymentsSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCoordinationofBenefitsOtherPaymentsSegment_BenefitStageQualifier(), theExternalCodeListPackage.getBenefitStageQualifier(), "benefitStageQualifier", null, 0, -1, CoordinationofBenefitsOtherPaymentsSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClinicalSegment_MeasurementDimension(), theExternalCodeListPackage.getMeasurementDimension(), "measurementDimension", null, 0, -1, ClinicalSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClinicalSegment_MeasurementUnit(), theExternalCodeListPackage.getMeasurementUnit(), "measurementUnit", null, 0, -1, ClinicalSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_FillNumber(), theExternalCodeListPackage.getFillNumber(), "fillNumber", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_NumberOfRefillsAuthorized(), theExternalCodeListPackage.getNumberofRefillsAuthorized(), "numberOfRefillsAuthorized", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_PrescriptionOriginCode(), theExternalCodeListPackage.getPrescriptionOriginCode(), "prescriptionOriginCode", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_SubmissionClarificationCode(), theExternalCodeListPackage.getSubmissionClarificationCode(), "submissionClarificationCode", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_OtherCoverageCode(), theExternalCodeListPackage.getOtherCoverageCode(), "otherCoverageCode", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_SpecialPackagingIndicator(), theExternalCodeListPackage.getSpecialPackagingIndicator(), "specialPackagingIndicator", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_UnitOfMeasure(), theExternalCodeListPackage.getUnitofMeasure(), "unitOfMeasure", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_LevelOfService(), theExternalCodeListPackage.getLevelofService(), "levelOfService", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_PriorAuthorizationTypeCode(), theExternalCodeListPackage.getPriorAuthorizationTypeCode(), "priorAuthorizationTypeCode", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_IntermediaryAuthorizationTypeId(), theExternalCodeListPackage.getIntermediaryAuthorizationTypeID(), "intermediaryAuthorizationTypeId", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_DispensingStatus(), theExternalCodeListPackage.getDispensingStatus(), "dispensingStatus", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_DelayReasonCode(), theExternalCodeListPackage.getDelayReasonCode(), "delayReasonCode", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_PatientAssignmentIndicatordirectMemberReimbursementIndicator(), theExternalCodeListPackage.getPatientAssignmentIndicatorDirectMemberReimbursementIndicator(), "patientAssignmentIndicatordirectMemberReimbursementIndicator", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_RouteOfAdministration(), theExternalCodeListPackage.getRouteOfAdministration(), "routeOfAdministration", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClaimSegment_CompoundType(), theExternalCodeListPackage.getCompoundType(), "compoundType", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getClaimSegment_PharmacyServiceType(), theExternalCodeListPackage.getPharmacyServiceType(), "pharmacyServiceType", null, 0, -1, ClaimSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getAdditionalDocumentationSegment_AdditionalDocumentationTypeId(), theExternalCodeListPackage.getAdditionalDocumentationTypeID(), "additionalDocumentationTypeId", null, 0, -1, AdditionalDocumentationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getAdditionalDocumentationSegment_RequestStatus(), theExternalCodeListPackage.getRequestStatus(), "requestStatus", null, 0, -1, AdditionalDocumentationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAdditionalDocumentationSegment_LengthOfNeedQualifier(), theExternalCodeListPackage.getLengthofNeedQualifier(), "lengthOfNeedQualifier", null, 0, -1, AdditionalDocumentationSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCompoundSegment_CompoundDosageFormDescriptionCode(), theExternalCodeListPackage.getCompoundDosageFormDescriptionCode(), "compoundDosageFormDescriptionCode", null, 0, -1, CompoundSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCompoundSegment_CompoundDispensingUnitFormIndicator(), theExternalCodeListPackage.getCompoundDispensingUnitFormIndicator(), "compoundDispensingUnitFormIndicator", null, 0, -1, CompoundSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCompoundSegment_CompoundProductIdQualifier(), theExternalCodeListPackage.getCompoundProductIDQualifier(), "compoundProductIdQualifier", null, 0, -1, CompoundSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseHeaderSegment_TransactionCode(), theExternalCodeListPackage.getTransactionCode(), "transactionCode", null, 1, 1, ResponseHeaderSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponseHeaderSegment_TransactionCount(), theExternalCodeListPackage.getTransactionCount(), "transactionCount", null, 1, 1, ResponseHeaderSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseCoordinationofBenefitsOtherPayersSegment_OtherPayerCoverageType(), theExternalCodeListPackage.getOtherPayerCoverageType(), "otherPayerCoverageType", null, 0, -1, ResponseCoordinationofBenefitsOtherPayersSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponseCoordinationofBenefitsOtherPayersSegment_OtherPayerIdQualifier(), theExternalCodeListPackage.getOtherPayerIDQualifier(), "otherPayerIdQualifier", null, 0, -1, ResponseCoordinationofBenefitsOtherPayersSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseCoordinationofBenefitsOtherPayersSegment_OtherPayerPatientRelationshipCode(), theExternalCodeListPackage.getOtherPayerPatientRelationshipCode(), "otherPayerPatientRelationshipCode", null, 0, -1, ResponseCoordinationofBenefitsOtherPayersSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseDURPPSSegment_ReasonForServiceCode(), theExternalCodeListPackage.getReasonforServiceCode(), "reasonForServiceCode", null, 0, -1, ResponseDURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseDURPPSSegment_OtherPharmacyIndicator(), theExternalCodeListPackage.getOtherPharmacyIndicator(), "otherPharmacyIndicator", null, 0, -1, ResponseDURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseDURPPSSegment_OtherPrescriberIndicator(), theExternalCodeListPackage.getOtherPrescriberIndicator(), "otherPrescriberIndicator", null, 0, -1, ResponseDURPPSSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseInsuranceSegment_PayerIdQualifier(), theExternalCodeListPackage.getPayerIDQualifier(), "payerIdQualifier", null, 0, -1, ResponseInsuranceSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_TaxExemptIndicator(), theExternalCodeListPackage.getTaxExemptIndicator(), "taxExemptIndicator", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_PercentageSalesTaxBasisPaid(), theExternalCodeListPackage.getPercentageSalesTaxBasisPaid(), "percentageSalesTaxBasisPaid", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_OtherAmountPaidQualifier(), theExternalCodeListPackage.getOtherAmountPaidQualifier(), "otherAmountPaidQualifier", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_BasisOfReimbursementDetermination(), theExternalCodeListPackage.getBasisOfReimbursementDetermination(), "basisOfReimbursementDetermination", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_BasisOfCalculationdispensingFee(), theExternalCodeListPackage.getBasisOfCalculationDispensingFee(), "basisOfCalculationdispensingFee", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponsePricingSegment_BasisOfCalculationcopay(), theExternalCodeListPackage.getBasisOfCalculationCopay(), "basisOfCalculationcopay", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponsePricingSegment_BasisOfCalculationflatSalesTax(), theExternalCodeListPackage.getBasisOfCalculationFlatSalesTax(), "basisOfCalculationflatSalesTax", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponsePricingSegment_BasisOfCalculationpercentageSalesTax(), theExternalCodeListPackage.getBasisOfCalculationPercentageSalesTax(), "basisOfCalculationpercentageSalesTax", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_BasisOfCalculationcoinsurance(), theExternalCodeListPackage.getBasisOfCalculationCoinsurance(), "basisOfCalculationcoinsurance", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponsePricingSegment_BenefitStageQualifier(), theExternalCodeListPackage.getBenefitStageQualifier(), "benefitStageQualifier", null, 0, -1, ResponsePricingSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseStatusSegment_TransactionResponseStatus(), theExternalCodeListPackage.getTransactionResponseStatus(), "transactionResponseStatus", null, 0, -1, ResponseStatusSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseStatusSegment_RejectCode(), theExternalCodeListPackage.getRejectCode(), "rejectCode", null, 0, -1, ResponseStatusSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseStatusSegment_AdditionalMessageInformationQualifier(), theExternalCodeListPackage.getAdditionalMessageInformationQualifier(), "additionalMessageInformationQualifier", null, 0, -1, ResponseStatusSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getResponseStatusSegment_AdditionalMessageInformationContinuity(), theExternalCodeListPackage.getAdditionalMessageInformationContinuity(), "additionalMessageInformationContinuity", null, 0, -1, ResponseStatusSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getResponseStatusSegment_HelpDeskPhoneNumberQualifier(), theExternalCodeListPackage.getHelpDeskPhoneNumberQualifier(), "helpDeskPhoneNumberQualifier", null, 0, -1, ResponseStatusSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
