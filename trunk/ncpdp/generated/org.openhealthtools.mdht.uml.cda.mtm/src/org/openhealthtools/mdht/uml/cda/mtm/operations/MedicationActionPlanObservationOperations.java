 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.mtm.MedicationActionPlanObservation#validateMedicationActionPlanObservationEffectiveTime(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Action Plan Observation Effective Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MedicationActionPlanObservationOperations extends PlanOfCareActivityObservationOperations {
  ...
  /**
   * The cached OCL expression body for the '{@link #validateMedicationActionPlanObservationEffectiveTime(MedicationActionPlanObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Action Plan Observation Effective Time</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateMedicationActionPlanObservationEffectiveTime(MedicationActionPlanObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.effectiveTime.oclIsUndefined() or self.effectiveTime.isNullFlavorUndefined()) implies (not self.effectiveTime.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateMedicationActionPlanObservationEffectiveTime(MedicationActionPlanObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Medication Action Plan Observation Effective Time</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateMedicationActionPlanObservationEffectiveTime(MedicationActionPlanObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateMedicationActionPlanObservationEffectiveTime(MedicationActionPlanObservation medicationActionPlanObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(MtmPackage.Literals.MEDICATION_ACTION_PLAN_OBSERVATION);
      try
      {
        VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationActionPlanObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             MtmValidator.DIAGNOSTIC_SOURCE,
             MtmValidator.MEDICATION_ACTION_PLAN_OBSERVATION__MEDICATION_ACTION_PLAN_OBSERVATION_EFFECTIVE_TIME,
             MtmPlugin.INSTANCE.getString("MedicationActionPlanObservationEffectiveTime"),
             new Object [] { medicationActionPlanObservation }));
      }
