...
public interface MtmPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.openhealthtools.mdht.uml.cda.mtm.impl.PersonalMedicationListImpl <em>Personal Medication List</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.openhealthtools.mdht.uml.cda.mtm.impl.PersonalMedicationListImpl
   * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MtmPackageImpl#getPersonalMedicationList()
   * @generated
   */
  int PERSONAL_MEDICATION_LIST = 1;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__REALM_CODE = ConsolPackage.MEDICATIONS_SECTION__REALM_CODE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__TYPE_ID = ConsolPackage.MEDICATIONS_SECTION__TYPE_ID;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__TEMPLATE_ID = ConsolPackage.MEDICATIONS_SECTION__TEMPLATE_ID;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__ID = ConsolPackage.MEDICATIONS_SECTION__ID;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__CODE = ConsolPackage.MEDICATIONS_SECTION__CODE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__TITLE = ConsolPackage.MEDICATIONS_SECTION__TITLE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__TEXT = ConsolPackage.MEDICATIONS_SECTION__TEXT;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__CONFIDENTIALITY_CODE = ConsolPackage.MEDICATIONS_SECTION__CONFIDENTIALITY_CODE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__LANGUAGE_CODE = ConsolPackage.MEDICATIONS_SECTION__LANGUAGE_CODE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__SUBJECT = ConsolPackage.MEDICATIONS_SECTION__SUBJECT;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__AUTHOR = ConsolPackage.MEDICATIONS_SECTION__AUTHOR;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__INFORMANT = ConsolPackage.MEDICATIONS_SECTION__INFORMANT;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__ENTRY = ConsolPackage.MEDICATIONS_SECTION__ENTRY;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__COMPONENT = ConsolPackage.MEDICATIONS_SECTION__COMPONENT;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__SECTION_ID = ConsolPackage.MEDICATIONS_SECTION__SECTION_ID;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__NULL_FLAVOR = ConsolPackage.MEDICATIONS_SECTION__NULL_FLAVOR;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__CLASS_CODE = ConsolPackage.MEDICATIONS_SECTION__CLASS_CODE;
   ...
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST__MOOD_CODE = ConsolPackage.MEDICATIONS_SECTION__MOOD_CODE;

  /**
   * The number of structural features of the '<em>Personal Medication List</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PERSONAL_MEDICATION_LIST_FEATURE_COUNT = ConsolPackage.MEDICATIONS_SECTION_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int MEDICATION_ACTION_PLAN_GOAL = 3;
   ...
   * @generated
   */
  int OTHER_INFORMATION_SECTION = 4;
  ...
  /**
   * The meta object id for the '{@link org.openhealthtools.mdht.uml.cda.mtm.impl.MedicationActionPlanImpl <em>Medication Action Plan</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MedicationActionPlanImpl
   * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MtmPackageImpl#getMedicationActionPlan()
   * @generated
   */
  int MEDICATION_ACTION_PLAN = 5;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__REALM_CODE = ConsolPackage.PLAN_OF_CARE_SECTION__REALM_CODE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__TYPE_ID = ConsolPackage.PLAN_OF_CARE_SECTION__TYPE_ID;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__TEMPLATE_ID = ConsolPackage.PLAN_OF_CARE_SECTION__TEMPLATE_ID;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__ID = ConsolPackage.PLAN_OF_CARE_SECTION__ID;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__CODE = ConsolPackage.PLAN_OF_CARE_SECTION__CODE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__TITLE = ConsolPackage.PLAN_OF_CARE_SECTION__TITLE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__TEXT = ConsolPackage.PLAN_OF_CARE_SECTION__TEXT;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__CONFIDENTIALITY_CODE = ConsolPackage.PLAN_OF_CARE_SECTION__CONFIDENTIALITY_CODE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__LANGUAGE_CODE = ConsolPackage.PLAN_OF_CARE_SECTION__LANGUAGE_CODE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__SUBJECT = ConsolPackage.PLAN_OF_CARE_SECTION__SUBJECT;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__AUTHOR = ConsolPackage.PLAN_OF_CARE_SECTION__AUTHOR;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__INFORMANT = ConsolPackage.PLAN_OF_CARE_SECTION__INFORMANT;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__ENTRY = ConsolPackage.PLAN_OF_CARE_SECTION__ENTRY;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__COMPONENT = ConsolPackage.PLAN_OF_CARE_SECTION__COMPONENT;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__SECTION_ID = ConsolPackage.PLAN_OF_CARE_SECTION__SECTION_ID;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__NULL_FLAVOR = ConsolPackage.PLAN_OF_CARE_SECTION__NULL_FLAVOR;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__CLASS_CODE = ConsolPackage.PLAN_OF_CARE_SECTION__CLASS_CODE;
   ...
   * @ordered
   */
  int MEDICATION_ACTION_PLAN__MOOD_CODE = ConsolPackage.PLAN_OF_CARE_SECTION__MOOD_CODE;

  /**
   * The number of structural features of the '<em>Medication Action Plan</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int MEDICATION_ACTION_PLAN_FEATURE_COUNT = ConsolPackage.PLAN_OF_CARE_SECTION_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int MEDICATION_ACTION_PLAN_ENCOUNTER = 6;
   ...
   * @generated
   */
  int MEDICATION_ACTION_PLAN_ACTIVITY = 7;
   ...
   * @generated
   */
  int MEDICATION_ACTION_PLAN_OBSERVATION = 8;
  ...
  /**
   * Returns the meta object for class '{@link org.openhealthtools.mdht.uml.cda.mtm.PersonalMedicationList <em>Personal Medication List</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Personal Medication List</em>'.
   * @see org.openhealthtools.mdht.uml.cda.mtm.PersonalMedicationList
   * @generated
   */
  EClass getPersonalMedicationList();
  ...
  /**
   * Returns the meta object for class '{@link org.openhealthtools.mdht.uml.cda.mtm.MedicationActionPlan <em>Medication Action Plan</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Medication Action Plan</em>'.
   * @see org.openhealthtools.mdht.uml.cda.mtm.MedicationActionPlan
   * @generated
   */
  EClass getMedicationActionPlan();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link org.openhealthtools.mdht.uml.cda.mtm.impl.PersonalMedicationListImpl <em>Personal Medication List</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.openhealthtools.mdht.uml.cda.mtm.impl.PersonalMedicationListImpl
     * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MtmPackageImpl#getPersonalMedicationList()
     * @generated
     */
    EClass PERSONAL_MEDICATION_LIST = eINSTANCE.getPersonalMedicationList();
    ...
    /**
     * The meta object literal for the '{@link org.openhealthtools.mdht.uml.cda.mtm.impl.MedicationActionPlanImpl <em>Medication Action Plan</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MedicationActionPlanImpl
     * @see org.openhealthtools.mdht.uml.cda.mtm.impl.MtmPackageImpl#getMedicationActionPlan()
     * @generated
     */
    EClass MEDICATION_ACTION_PLAN = eINSTANCE.getMedicationActionPlan();
